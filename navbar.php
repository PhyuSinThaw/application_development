...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=city" class="nav-item nav-city"><span class='icon-field'><i class="fas fa-city "></i></span> City</a>
				<a href="index.php?page=houses" class="nav-item nav-houses"><span class='icon-field'><i class="fa fa-building "></i></span> Houses</a>
				<a href="index.php?page=agents" class="nav-item nav-agents"><span class='icon-field'><i class="fa fa-user-friends "></i></span> Agents</a>
				...
				<a href="homepg.php" class="nav-item nav-reports"><span class='icon-field'><i class="fa fa-home"></i></span> Home Page</a>
			<?php endif; ?>
		</div>
