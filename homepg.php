...
<head>
	...
	<link rel="stylesheet" href="assets/font-awesome/icomoon/style.css">
	<link rel="stylesheet" href="assets/font-awesome/flaticon/font/flaticon.css">

	<link rel="stylesheet" href="assets/css/tiny-slider.css">
	<link rel="stylesheet" href="assets/css/aos.css"justify-conendtent-xl-endburger>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
	...
	<title>STAY Estate Agency</title>
</head>
<body>
	<nav class="site-nav">
		<div class="container">
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<a href="homepg.php" class="logo m-0 float-start">Property</a>
					...
					<ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
						...
						<li class="has-children">
							<a href="#"><img src="/examples/images/avatar/2.jpg" class="avatar" alt="Avatar"> Paula Wilson <b class="caret"></b></a>
							<ul class="dropdown">
		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					<h1 class="heading" data-aos="fade-up">Find your dream home</h1>
